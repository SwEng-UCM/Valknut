...
public class EnemyBuilder {
    ...
    static public Enemy buildEnemy(String str){
        ...
        switch (str.toLowerCase()) {
            case "ice" -> {
                Enemy iceGiant = new Enemy(Messages.ICEGIANT, 60, 200, 60, Messages.ICEGIANT_ATTACK);
            ...
            case "fire" -> {
                Enemy fireGiant = new Enemy(Messages.FIREGIANT, 60, 200, 70, Messages.FIREGIANT_ATTACK);
            ...
            case "draug" -> {
            	Enemy draugr = new Enemy(Messages.DRAUGR, 60, 120, 60, Messages.DRAUGR_ATTACK);
